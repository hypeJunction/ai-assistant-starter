...
description: Naming conventions for TypeScript including variables, functions, classes, files, and API endpoints. Auto-loaded when writing or reviewing code.
